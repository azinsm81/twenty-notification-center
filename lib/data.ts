...
export const NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    urgent: false,
    read: false,
    title: "Commerce product import finished.",
    description: "The product import process has completed. You can view the results on the Import page.",
    timestamp: "2 hr ago",
    dateGroup: "Today",
  ...
  },
  {
    ...
    urgent: false,
    read: false,
    title: "We're done importing your contacts",
    description: "1 contact was imported",
